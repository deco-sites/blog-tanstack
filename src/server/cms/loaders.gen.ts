...
export const siteLoaders: Record<string, (props: any, request?: Request) => Promise<any>> = {
  "site/loaders/BlogpostList": async (props: any, request?: Request) => {
    const mod = await import("../../loaders/BlogpostList");
    return (mod.default as any)(props, request);
  },
  "site/loaders/BlogpostList.ts": async (props: any, request?: Request) => {
    const mod = await import("../../loaders/BlogpostList");
    return (mod.default as any)(props, request);
  },
};
