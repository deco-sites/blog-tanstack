import type { BlogPost, Author } from "@decocms/apps/blog/types";
          ...
          {authors.map((author, i) => (
            <div
              ...
              style={{
                ...
                transition: `opacity 400ms cubic-bezier(0.16,1,0.3,1) ${i * 60}ms, transform 400ms cubic-bezier(0.16,1,0.3,1) ${i * 60}ms, border-color 0.2s ease`,
              }}
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                  ...
                  {author.jobTitle && (
                    <span className="text-xs text-[#7a7a74] truncate">{author.jobTitle}</span>
                  )}
